...
drop view vwRIPS_HPRED_SER_1_2
go
...
-- TGENGD se debe llenar de la configuración hecha en Oncomedica8 de pruebas
/*
truncate table TGENGD;
go

insert into TGENGD(TABLA,CAMPO,GRUPO,CODIGO,DESCRIPCION,VALOR1A,VALOR1B,DATO1A,DATO1B)
select TABLA,CAMPO,GRUPO,CODIGO,DESCRIPCION,VALOR1A,VALOR1B,DATO1A,DATO1B from Oncomedica8..TGENGD
go
*/
-- select * from TGENGD
