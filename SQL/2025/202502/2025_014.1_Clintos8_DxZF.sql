...
as
	...
	from DxZF.dbo.IGEN with(nolock)
go
...
returns table as return(
	...
	from (
		...
		from DxZF.dbo.vwdx_INV_VentasPacientes_Clintos_con_LOTESERIE a with(nolock/*,noexpand*/) 
		...
		from DxZF.dbo.vwdx_INV_VentasPacientes_Clintos_sin_LOTESERIE a with(nolock/*,noexpand*/)
			left join DxZF.dbo.IMOVHD l with(nolock) on l.IDTRANSACCION=a.IDTRANSACCION and l.NUMDOCUMENTO=a.NUMDOCUMENTO 
