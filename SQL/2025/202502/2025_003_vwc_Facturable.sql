...
as  
 select ORIGEN='CIT', a.IDTERCEROCA, a.COBRARA, a.IDSERVICIOADM, a.IDSEDE, a.NOADMISION, FECHAALTA=a.FECHA, IDAREA_ALTA=a.IDAREA, CCOSTO_ALTA=a.CCOSTO,   
  ...
  VALORCOPAGO=cast(coalesce(a.VALORCOPAGO,0) as decimal(14,2)), VALORPCOMP=cast(0 as decimal(14,2)),
  VALORMODERADORA=cast(coalesce(a.VALORMODERADORA,0) as decimal(14,2)), DESCUENTO=cast(coalesce(a.DESCUENTO,0) as decimal(14,2)),  
